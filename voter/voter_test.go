...
var calculateAndAddUpVoteTests = []struct {
	...
	{model.VoterTypeSuper, map[string]struct{}{}, map[string]struct{}{}, 0, "song1", 2, false, false},
	...
	{model.VoterTypeSuper, map[string]struct{}{}, map[string]struct{}{"song1": emptyStructValue}, 0, "song1", 3, false, false},
...
var calculateAndAddDownVoteTests = []struct {
	...
	{model.VoterTypeSuper, map[string]struct{}{}, map[string]struct{}{}, "song1", -1, false},
	...
	{model.VoterTypeSuper, map[string]struct{}{}, map[string]struct{}{"song1": emptyStructValue}, "song1", 0, true},
	...
	{model.VoterTypeSuper, map[string]struct{}{"song1": emptyStructValue}, map[string]struct{}{}, "song1", -3, true},
...
var calculateAndRemoveUpVoteTests = []struct {
	...
	{model.VoterTypeSuper, map[string]struct{}{"song1": emptyStructValue}, "song1", -2},
...
var calculateAndRemoveDownVoteTests = []struct {
	...
	// Test voter types for regular vote
	{model.VoterTypeFree, map[string]struct{}{"song1": emptyStructValue}, "song1", 1},
	{model.VoterTypeSuper, map[string]struct{}{"song1": emptyStructValue}, "song1", 1},
	{model.VoterTypeAdmin, map[string]struct{}{"song1": emptyStructValue}, "song1", 1},
}
